  ...
  return (
    ...
    <Navbar className='bg-gray-900 fixed w-full'>
      ...
      <NavbarCollapse className=' p-4 md:p-0 mt-4 border border-[#e26767] rounded-lg md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0'>
        ...
        <NavLink to={'/src/assets/docs/CV_AFAR.pdf'} target='_blank' download={'CV_AndresAlfonso.pdf'} className='p-2 flex items-center gap-x-1 font-bold rounded hover:-translate-y-0.5 text-[#e26767] hover:bg-red-300/10 transition duration-150 border-2 border-red-300/80'>
            CV
