        ...
        <div className='perfil-content grid gap-3'>
          <div className='perfil-data mt-10'>
            ...
            <div className='inline-flex'>
              <h1 className='text-white text-3xl md:text-4xl lg:text-5xl font-bold text-bunker-100 flex flex-grow gap-x-4'>Andrés Alfonso <StatusWork/></h1>
            </div>
      ...
      <section className='skills my-14' id='skills'>
        <div className='skills-content bg-bunker-950/50 px-6 lg:px-8 py-6'>
          ...
          <div className="mt-8 grid grid-cols-2 lg:grid-cols-4 sm:grid-cols-3 gap-2 lg:gap-6 group/list">
            ...
            <div className="text-red-300/80 p-2 bg-bunker-800/10 rounded-lg flex flex-col items-center justify-center">
            <svg  xmlns="http://www.w3.org/2000/svg"  width="48"  height="48"  viewBox="0 0 22 22"  fill="none"  stroke="currentColor"  stroke-width="1.25" stroke-linecap="round"  stroke-linejoin="round"  className="icon icon-tabler icons-tabler-outline icon-tabler-brand-php"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 12m-10 0a10 9 0 1 0 20 0a10 9 0 1 0 -20 0" /><path d="M5.5 15l.395 -1.974l.605 -3.026h1.32a1 1 0 0 1 .986 1.164l-.167 1a1 1 0 0 1 -.986 .836h-1.653" /><path d="M15.5 15l.395 -1.974l.605 -3.026h1.32a1 1 0 0 1 .986 1.164l-.167 1a1 1 0 0 1 -.986 .836h-1.653" /><path d="M12 7.5l-1 5.5" /><path d="M11.6 10h2.4l-.5 3" /></svg>
              <h5 className="text-sm lg:text-md font-medium mt-2">Php</h5>
            </div>
          </div>
        </div>
      </section>
